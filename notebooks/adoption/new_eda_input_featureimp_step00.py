...
def run_cohort_pipeline(config: ModelConfig):
    ...
    model_lgb = lgb.LGBMClassifier(**best_params_lgb, random_state=random_state,verbosity=-1)
    ...
    for class_idx in range(champion_shap_values.shape[2]):  
        ...
        class_plot_path = f"outputs/adoption_cohort/step0_preprocessing/{cohort_champion_model_prefix}_SHAPIMPPLOT_{profile_names[class_idx]}.png"
